...
public class UsuariosDao {
    ...
    ResultSet rs;
     ...
     public Usuarios validar(int rut, String pass) {
        String sql = "SELECT * from usuarios where zeus_rut=? and pass=? and estado=1";
    ...
    public Usuarios ingresar(int rut, String dv, String nombre, String direccion, String correo, String fono) {
